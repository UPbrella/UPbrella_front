...
const HowReturn = () => {
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="bg-primary-100 w-full">
        <section className="flex flex-row-reverse justify-center lg:flex-col md:flex-col sm:flex-col w-full gap-10 lg:max-w-680 lg:px-40 sm:px-20">
          ...
          <div className="flex gap-x-4 mt-95 lg:mt-40 lg:mx-auto">
      ...
      <section className="flex flex-row justify-center lg:flex-col md:flex-col sm:flex-col w-full gap-10	lg:max-w-680 xl:h-520 lg:px-40 sm:px-20">
        ...
        <img src={return_step5} className="w-280 h-418 mt-102 lg:mt-40 lg:mx-auto" />
      </section>
    </div>
  );
};
