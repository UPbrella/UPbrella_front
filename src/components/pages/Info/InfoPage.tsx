    ...
    <div className="px-120 pt-24">
      ...
      <section className="flex justify-center w-full gap-10" style={{ height: "520px" }}>
        <div className="flex flex-col pt-194">
          ...
          <div>홈페이지 '대여소 위치'페이지 내 가장 가까운 협업 지점 방문하기 </div>
          <div>교외 지점의 경우 반드시 영업시간을 확인해주세요! </div>
        </div>
      ...
      <section className="flex justify-center w-full gap-10	" style={{ height: "520px" }}>
        <div className="flex flex-col mt-194">
          ...
          <div>다음 이용자분들을 위해 사용 후 빠르게 반납 부탁드립니다 😊</div>
          <div>원활한 서비스 운영을 위해 최대 대여 기간은 14일로 한정하고 있습니다.</div>
        </div>
